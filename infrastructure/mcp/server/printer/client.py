...
class PrinterAPIClient:
    ...
    def __init__(self, base_url: str = "http://192.168.5.14:9080", timeout: int = 10, debug: bool = True):
        """
        初始化打印机API客户端
        
        Args:
            base_url: 打印机API基础URL
            timeout: 请求超时时间（秒）
            debug: 是否打印原始数据（默认开启）
        """
    ...
    async def get_sse_with_field(self, endpoint: str, required_field: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
